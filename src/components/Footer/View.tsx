...
const Footer = () => {
	return (
		<footer className="w-100 bg-white dark:bg-zinc-900 flex flex-col-reverse xs:flex-row items-center justify-center px-4 lg:px-0 py-5 w-full text-primary-200 dark:text-txt-300">
